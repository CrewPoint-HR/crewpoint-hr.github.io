...
function showFormError(){
    ...
    errorEl.innerHTML='<p style="font-size:.9rem;color:var(--red);font-weight:600;margin-bottom:12px">⚠ Не удалось отправить заявку — проблемы с сетью</p><p style="font-size:.85rem;color:var(--text-secondary);line-height:1.6;margin-bottom:16px">Напишите нам напрямую — ответим за 5 минут:</p><div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap"><a href="https://wa.me/79930728324" target="_blank" rel="noopener noreferrer" style="padding:12px 20px;background:#25D366;color:#fff;border-radius:8px;font-weight:600;font-size:.85rem;text-decoration:none">📱 WhatsApp</a><a href="https://t.me/CrewPoint_HR" target="_blank" rel="noopener noreferrer" style="padding:12px 20px;background:#2AABEE;color:#fff;border-radius:8px;font-weight:600;font-size:.85rem;text-decoration:none">✈ Telegram</a><a href="tel:+79930728324" style="padding:12px 20px;background:rgba(255,255,255,0.08);color:#fff;border:1px solid rgba(255,255,255,0.15);border-radius:8px;font-weight:600;font-size:.85rem;text-decoration:none">📞 +7 (993) 072-83-24</a></div>';
